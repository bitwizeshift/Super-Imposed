...
#ifndef VDK_UTIL_SAFE_ENUM_HPP_
#define VDK_UTIL_SAFE_ENUM_HPP_
...
namespace vdk{
	...
	template<
		...
		typename inner = typename def::type
	>
	class safe_operable_enum : public def{
